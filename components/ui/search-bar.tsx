...
export default function SearchBar({ messages, className }: SearchBarProps) {
  ...
  return (
    <form className={cn('flex h-9', className)}>
      <label className="peer flex h-full w-full items-center rounded-xl bg-gray-400 bg-opacity-20 p-2 transition-[background-color] active:bg-opacity-30 dark:bg-gray-500 dark:bg-opacity-20">
      ...
      <div
        className="w-0 opacity-0 transition-all duration-300 peer-focus-within:w-[var(--width)] peer-focus-within:opacity-100 md:hidden"
